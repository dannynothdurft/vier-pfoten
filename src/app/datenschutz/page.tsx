...
export default function DatenschutzPage() {
  return (
    ...
    <p>
        ...
        Geschäftsführer: Danny Nothdurft<br />
        Tribünenweg 32<br />
        22111 Hamburg<br />
        Telefon: <a href="tel:+4917656612113">0176 56612113</a><br />
        E-Mail: <a href="mailto:danny.nothdurft@icloud.com">danny.nothdurft@icloud.com</a>
    </p>
    ...
    <p>
        Beim Aufrufen unserer Website werden durch den auf deinem Endgerät zum Einsatz kommenden Browser automatisch 
        Informationen an den Server unserer Website gesendet. Diese Informationen werden temporär in einem sogenannten 
        Logfile gespeichert. Folgende Informationen werden dabei ohne dein Zutun erfasst und bis zur automatisierten 
    ...
    <p>
        Bei der Registrierung auf unserer Website werden folgende personenbezogenen Daten erhoben:
    </p>
    <ul>
    ...
    <p>
        Die Datenverarbeitung erfolgt auf deine Anfrage hin und ist nach Art. 6 Abs. 1 S. 1 lit. b DSGVO zu den 
        genannten Zwecken für die angemessene Bearbeitung deiner Registrierung und für die beidseitige Erfüllung 
        von Verpflichtungen aus dem Nutzungsvertrag erforderlich.
    </p>
    ...
    <p>
        ...
        auf Grundlage deiner freiwillig erteilten Einwilligung.
    </p>
    ...
    <ul>
        ...
        schutzwürdiges Interesse an der Nichtweitergabe deiner Daten hast,</li>
        <li>für den Fall, dass für die Weitergabe nach Art. 6 Abs. 1 S. 1 lit. c DSGVO eine gesetzliche Verpflichtung 
        besteht, sowie</li>
        <li>dies gesetzlich zulässig und nach Art. 6 Abs. 1 S. 1 lit. b DSGVO für die Abwicklung von Vertragsverhältnissen 
        mit dir erforderlich ist.</li>
    </ul>

    <h2>4. Cookies</h2>
    <p>
        Wir setzen auf unserer Website Cookies ein. Hierbei handelt es sich um kleine Dateien, die dein Browser 
        automatisch erstellt und die auf deinem Endgerät (Laptop, Tablet, Smartphone o.ä.) gespeichert werden, wenn 
        du unsere Seite besuchst. Cookies richten auf deinem Endgerät keinen Schaden an, enthalten keine Viren, 
    ...
    <p>
        werden an einen Server von Google in den USA übertragen und dort gespeichert. Diese Informationen werden genutzt, 
